  ...
  return (
    <section>
     <div className="border-grey-100 border-b w-full">
         <div className={cn(`relative lg:sticky lg:top-0  mx-auto h-20 my-auto w-full flex items-center   justify-between   md:justify-center lg:justify-end   px-5  md:px-[36px]`,
